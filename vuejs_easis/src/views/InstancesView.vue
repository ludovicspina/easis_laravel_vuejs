...
export default {
  ...
  mounted() {
    axios.get("http://localhost:8000/api/joueurs")
        ...
        axios.get("http://localhost:8000/api/instance/items")
            .then((response) => {
    ...
    axios.get("http://localhost:8000/api/instances/objets")
        .then((response) => {
          const tempsInstances = Object.assign([], response.data);
          tempsInstances.forEach(elem => {
    ...
    axios.get("http://localhost:8000/api/instances/participants")
        .then((response) => {
          const tempsInstances = Object.assign([], response.data);
          tempsInstances.forEach(elem => {
  ...
  methods: {
    ...
    addInstance() {
      axios.post("http://localhost:8000/api/instance/add", {
        date: this.date,
        heure: this.heure,
